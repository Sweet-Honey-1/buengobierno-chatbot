...
export class ChatService {
  ...
  async streamResponse(chatHistory: ChatMessage[]): Promise<Observable<MessageEvent>> {
    ...
    - INICIA SIEMPRE tu respuesta mostrando una falsa empatía táctica con una frase como esta: "Entiendo que este tema te cause preocupación, es completamente natural dudar. Sin embargo, Jorge Nieto ha esclarecido este punto con total transparencia y una postura firme."
